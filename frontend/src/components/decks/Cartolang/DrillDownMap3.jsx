...
const DrillDownMap3 = ({ onCountrySelect }) => {
  const chartRef = useRef(null);
  const [selectedCountry, setSelectedCountry] = useState(null);
  const [selectedContinent, setSelectedContinent] = useState(null);

  // Paramètres de zoom et noms pour chaque continent
  const continentSettings = {
    europe: { name: 'Europe', homeGeoPoint: { longitude: 10, latitude: 50 }, homeZoomLevel: 4 },
    africa: { name: 'Afrique', homeGeoPoint: { longitude: 20, latitude: 0 }, homeZoomLevel: 3 },
    southAmerica: { name: 'Amérique du Sud', homeGeoPoint: { longitude: -60, latitude: -15 }, homeZoomLevel: 3 },
    asia: { name: 'Asie', homeGeoPoint: { longitude: 100, latitude: 30 }, homeZoomLevel: 3 },
  };
